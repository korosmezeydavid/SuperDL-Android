...
gh release create v1.63.7 (Join-Path $dir 'SuperDL.apk') (Join-Path $dir 'SuperDL-1.63.7.apk') --repo korosmezeydavid/SuperDL-Android --title "1.63.7 - A csuszkak, a sebesseg, es a radio ami nem alszik el" --notes-file 'C:\Users\msn\Documents\SuperDL-Android\tools\relnotes1637.md'

Write-Output ''
Write-Output '=== 3. VERZIOFAJL ==='
$file = 'C:\Users\msn\Documents\SuperDL-Android\tools\verzio1637.json'
$bytes = [System.IO.File]::ReadAllBytes($file)
if ($bytes.Length -lt 100) { throw "A fajl gyanusan rovid." }
$b64 = [System.Convert]::ToBase64String($bytes)
$tmp = 'C:\Users\msn\Documents\SuperDL-Android\tools\_verzio1637_api.json'
$sha = (gh api repos/korosmezeydavid/SuperDL/contents/verzio.json?ref=mobil --jq '.sha')
$payload = @{
    message = "1.63.7 - csuszkak, olvaso-sebesseg, radio elalvas, m3u beolvasas"
    content = $b64
    sha     = $sha
    branch  = "mobil"
