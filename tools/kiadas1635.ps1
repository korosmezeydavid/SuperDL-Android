...
gh release create v1.63.5 (Join-Path $dir 'SuperDL.apk') (Join-Path $dir 'SuperDL-1.63.5.apk') --repo korosmezeydavid/SuperDL-Android --title "1.63.5 - Az inditopult, ami eddig hianyzott" --notes-file 'C:\Users\msn\Documents\SuperDL-Android\tools\relnotes1635.md'

Write-Output ''
Write-Output '=== 3. VERZIOFAJL ==='
$file = 'C:\Users\msn\Documents\SuperDL-Android\tools\verzio1635.json'
$bytes = [System.IO.File]::ReadAllBytes($file)
if ($bytes.Length -lt 100) { throw "A fajl gyanusan rovid." }
$b64 = [System.Convert]::ToBase64String($bytes)
$tmp = 'C:\Users\msn\Documents\SuperDL-Android\tools\_verzio1635_api.json'
$sha = (gh api repos/korosmezeydavid/SuperDL/contents/verzio.json?ref=mobil --jq '.sha')
$payload = @{
    message = "1.63.5 - inditopult, celra kereses, felirat kereses, naptari muvelet"
    content = $b64
    sha     = $sha
    branch  = "mobil"
