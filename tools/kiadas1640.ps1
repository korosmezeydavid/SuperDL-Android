...
gh release create v1.64.0 (Join-Path $dir 'SuperDL.apk') (Join-Path $dir 'SuperDL-1.64.0.apk') --repo korosmezeydavid/SuperDL-Android --title "1.64.0 - Minden kedden ot ora, es az uzenet, ami megmondja az igazat" --notes-file 'C:\Users\msn\Documents\SuperDL-Android\tools\relnotes1640.md'

Write-Output ''
Write-Output '=== 3. VERZIOFAJL ==='
$file = 'C:\Users\msn\Documents\SuperDL-Android\tools\verzio1640.json'
$bytes = [System.IO.File]::ReadAllBytes($file)
if ($bytes.Length -lt 100) { throw "A fajl gyanusan rovid." }
$b64 = [System.Convert]::ToBase64String($bytes)
$tmp = 'C:\Users\msn\Documents\SuperDL-Android\tools\_verzio1640_api.json'
$sha = (gh api repos/korosmezeydavid/SuperDL/contents/verzio.json?ref=mobil --jq '.sha')
$payload = @{
    message = "1.64.0 - MK-V M0+M1: igazmondo SMS-kuldes, ebreszto adott napokon"
    content = $b64
    sha     = $sha
    branch  = "mobil"
